...
class Main(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		wxglade_tmp_menu = wx.Menu()
		wxglade_tmp_menu.Append(wx.ID_COPY, _("&Copy"), "", wx.ITEM_NORMAL)
		wxglade_tmp_menu.Append(wx.ID_CUT, _("Cu&t"), "", wx.ITEM_NORMAL)
		wxglade_tmp_menu.Append(wx.ID_PASTE, _("&Paste"), "", wx.ITEM_NORMAL)
		wxglade_tmp_menu.AppendSeparator()
