...
class Main(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		wxglade_tmp_menu.Append(wx.ID_NEW, _("&New project"), "", wx.ITEM_NORMAL)
		wxglade_tmp_menu.Append(wx.ID_OPEN, _("&Open project"), "", wx.ITEM_NORMAL)
		wxglade_tmp_menu.AppendSeparator()
		wxglade_tmp_menu.Append(wx.ID_EXIT, _("E&xit"), "", wx.ITEM_NORMAL)
